...
class BroadcastCheck(Base):
    def scan(self):
        ...
        if getSysType() == 'mac':
            ...
            strline = cmdString(f'cd {self.appPath} | (findstr /s "registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent" *.smali)')
