...
class SoLoadCheck(Base):
    def scan(self):
        ...
        if getSysType() == 'mac':
            strline = cmdString('grep -r "Ljava/lang/System;->load(Ljava/lang/String;)V" ' + self.appPath)
        elif getSysType() == 'win':
            strline = cmdString(f'cd {self.appPath} | (findstr /s "Ljava/lang/System;->load(Ljava/lang/String;)V" *.smali)')
