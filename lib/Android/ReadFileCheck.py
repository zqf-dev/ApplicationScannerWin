...
class ReadFileCheck(Base):
    def scan(self):
        ...
        if getSysType() == 'mac':
            ...
            strline = cmdString(f'cd {self.appPath} | (findstr /s /i "getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences Landroid/content/Context;->getDir Landroid/content/Context;->openFileOutput" *.smali)')
