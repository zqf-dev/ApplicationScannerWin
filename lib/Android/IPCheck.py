...
class IPCheck(Base):
    def scan(self):
        ...
        # strline = f'cd {self.appPath} && (findstr /s "[0-9][0-9]*\\.[0-9][0-9]*\\.[0-9][0-9]*\\.[0-9][0-9]*" *.smali)'
        strline = f'cd {self.appPath} && (findstr /s "(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)" *.smali)'
