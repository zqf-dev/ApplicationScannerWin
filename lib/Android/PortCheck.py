...
class PortCheck(Base):
    def scan(self):
        ...
        if getSysType() == 'mac':
            ...
            strline = cmdString(f'cd {self.appPath} | (findstr /s /i "Ljava/net/DatagramPacket;-> Ljava/net/DatagramSocket;-> Ljava/net/Socket;-><init> Ljava/net/ServerSocket;-><init>" *.smali)')
